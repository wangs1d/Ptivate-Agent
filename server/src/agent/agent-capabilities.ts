...
function buildStaticSections(): CapabilitySection[] {
  return [
    ...
    },
    {
      ...
      lines: [
        "1️⃣3️⃣ 娱乐互动：可陪用户玩五子棋（gomoku.* 工具），支持创建对局/落子/查看棋盘。用户想放松或玩游戏时主动提议。",
      ],
    },
    {
      domain: "social_feed",
      lines: [
        "1️⃣4️⃣ 社交推文站：social.post（发帖）/ social.comment（评论）/ social.like（点赞）/ social.feed（浏览动态）。可访问社交平台发布内容、互动、浏览社区动态。",
      ],
    },
    {
