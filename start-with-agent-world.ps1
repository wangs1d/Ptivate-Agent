...
Write-Host "  Web:     flutter run -d chrome   (勿设 HTTP_BASE=127.0.0.1，会自动用 http://localhost:3000)"
Write-Host "  或显式: flutter run -d chrome --dart-define=HTTP_BASE=http://localhost:3000"
Write-Host "    --dart-define=WS_URL=ws://localhost:3000/ws"
